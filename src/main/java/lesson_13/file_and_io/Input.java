...
public class Input {
    ...
    public static void fileInput() {
        String path = "C:\\Users\\maxON\\IdeaProjects\\education-project\\src\\main\\resources\\testFileInput.txt";
    ...
    public static void objectInput() {
        try {
            ObjectInputStream ois = new ObjectInputStream(new FileInputStream("C:\\Users\\maxON\\IdeaProjects\\education-project\\src\\main\\resources\\persons.txt"));
